...
| [`csv`](csv) | normal analysis: stdlib `encoding/csv` → filter → summarize → `nb/chart` Table + Bar, no dataframe | 201 | [charts](https://go-notebook.dev/docs/reference-charts.html) |
